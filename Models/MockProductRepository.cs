...
namespace Bageriet.Models
{
    public class MockProductRepository : IProductRepository
    {
        ...
        public IEnumerable<Product> AllProducts =>
            new List<Product>
            {
                new Product {ProductId=1, Name="Bagarens favorit", Description="Riktigt gott bröd!", Category = _categoryRepository.AllCategories.ToList()[0], ImageUrl="https://img.koket.se/media/italienskt-surdegsbrod.jpg", IsProductOfTheWeek = true, ImageThumbnailUrl="https://img.koket.se/media/italienskt-surdegsbrod.jpg"},
                new Product {ProductId=2, Name="Surdegsbröd", Description="Riktigt gott surdegsbröd!", Category = _categoryRepository.AllCategories.ToList()[0], ImageUrl="https://img.koket.se/media/italienskt-surdegsbrod.jpg", IsProductOfTheWeek=true, ImageThumbnailUrl="https://img.koket.se/media/italienskt-surdegsbrod.jpg"},
